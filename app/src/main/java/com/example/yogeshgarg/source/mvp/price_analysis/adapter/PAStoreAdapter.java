...
public class PAStoreAdapter extends RecyclerView.Adapter<PAStoreAdapter.Holder> implements Filterable {
    ...
    public PAStoreAdapter(Activity activity, ArrayList<PriceAnalysisModel.Result.Original> originalArrayList) {
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        holder.txtViewName.setText(item.getStoreName());
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (strCharSequence.isEmpty()) {
                    ...
                    for (PriceAnalysisModel.Result.Original original : originalArrayList) {
                        if (original.getStoreName().toLowerCase().contains(strCharSequence)) {
